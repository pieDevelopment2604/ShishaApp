...
class SideBarB extends StatefulWidget {
  @override
  _SideBarBState createState() => _SideBarBState();
}

class _SideBarBState extends State<SideBarB>
    with SingleTickerProviderStateMixin<SideBarB> {
        ...
        return AnimatedPositioned(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection("bars/" +
                      Shish.sharedPreferences.getString(Shish.barUID) +
                      "/commandes")
                  .snapshots(),
                            ...
                            child: GestureDetector(
                              ...
                              child: ClipPath(
                                ...
                                child: Container(
                                    ...
                                    child: datasnapshot.data.docs.length == 0
                                        ? AnimatedIcon(
