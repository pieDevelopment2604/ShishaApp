...
class GoutsList extends StatefulWidget with NavStates{
  final List<Gout> gouts;

  const GoutsList({Key key, this.gouts}) : super(key: key);
  @override
  _GoutsListState createState() => _GoutsListState();
}

class _GoutsListState extends State<GoutsList> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barGouts").snapshots(),
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Gout : ", style: GoogleFonts.abel(
                      fontSize: 12,
                  ...
                  child: FlatButton(
                    ...
                    onPressed: (){
                      setState(() {
                        ...
                        FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barGouts").doc((widget.index+1).toString()).update({
                          "etat":"0"
