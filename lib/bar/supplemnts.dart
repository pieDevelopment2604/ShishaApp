...
class SuppsList extends StatefulWidget with NavStates{
  final List<Supp> supps;

  const SuppsList({Key key, this.supps}) : super(key: key);
  @override
  _SuppsListState createState() => _SuppsListState();
}

class _SuppsListState extends State<SuppsList> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barSupps").snapshots(),
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Supplément : ", style: GoogleFonts.abel(
                      fontSize: 12,
                  ...
                  child: FlatButton(
                    ...
                    onPressed: (){
                      setState(() {
                        ...
                        FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barSupps").doc((widget.index+1).toString()).update({
                          "etat":"0"
