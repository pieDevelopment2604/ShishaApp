...
class AccosList extends StatefulWidget with NavStates{
  final List<Acco> accos;

  const AccosList({Key key, this.accos}) : super(key: key);
  @override
  _AccosListState createState() => _AccosListState();
}

class _AccosListState extends State<AccosList> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barAccos").snapshots(),
          builder: (context, snapshot) {
            return !snapshot.hasData?Center(child: Text("Chargement ..."),): ListView.builder(
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text("Accompagnement : ", style: GoogleFonts.abel(
                      fontSize: 12,
                  ...
                  child: FlatButton(
                    ...
                    onPressed: (){
                      setState(() {
                        ...
                        FirebaseFirestore.instance.collection("bars/"+Shish.sharedPreferences.getString(Shish.barUID)+"/barAccos").doc((widget.index+1).toString()).update({
                          "etat":"0"
